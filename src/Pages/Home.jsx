                ...
                <div className='sm:w-[554px] sm:h-[115px] flex flex-col gap-[20px]'>
                  ...
                  <div className='flex gap-[30px] h-fit  text-white'>
                    <button id='playstore' className='flex justify-center items-center gap-[10px] bg-[color:var(--alternate-primary-color)] p-[10px] sm:p-[12px] sm:w-[200px] h-fit w-full rounded-[10px]'>
                        <span className='sm:w-[40px] sm:h-[40px]'>
                        ...
                        <p className='sm:w-[80%] text-left sm:text-[100%] text-[80%]'>Download on <span className='font-bold block sm:text-[22px] font-interHead'>Play Store</span></p>
                    </button>

                    <button id='appstore' className='flex justify-center items-center gap-[10px] bg-[color:var(--secondary-color)] p-[10px] sm:p-[12px] sm:w-[200px] h-fit w-full rounded-[10px]'>
                        <span className='sm:w-[40px] sm:h-[40px]'>
                            <svg width="30" height="30" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
