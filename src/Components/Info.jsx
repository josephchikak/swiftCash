...
const Info = () => {
  ...
  return (
    <div id='info' className='h-screen p-2 w-[100%] bg-[color:var(--secondary-color)] flex justify-center items-center text-white text-right font-inter relative sm:leading-8'>
      
        <div className='w-[80vh] h-[45%] flex relative'>

        <p id='swiftPay' ref={swiftRef} className='text-[0.7rem] md:text-[15px] lg:text-[1rem]  absolute right-[60%] top-[100%] sm:right-[70%] md:top-[105%] md:right-[75%] lg:top-[125%] z-40 w-[80%] sm:w-[100%] break-normal  sm:leading-8'>
          ...
          <p id='wallet' ref={walletRef} className='-rotate-90 sm:rotate-0 text-[0.7rem] sm:text-right text-left md:text-[15px] lg:text-[1rem]  absolute right-[52%] md:right-[85%] md:bottom-[95%] lg:right-[100%] bottom-[90%] lg:bottom-[70%] w-[80%] sm:w-[100%] break-normal z-40  sm:leading-8'>
          ...
          <p id='virtualCard'ref={virtualRef}  className='text-[0.7rem]  md:text-[15px] lg:text-[1rem] ]  text-left absolute md:left-[85%] md:bottom-[95%] lg:left-[101%] left-[60%] bottom-[105%] lg:bottom-[90%] w-[80%] sm:w-[100%] break-normal  z-40  sm:leading-8'>
          ...
          <p id='transactions' ref={transactionRef} className=' text-[0.7rem]  md:text-[15px] lg:text-[1rem]  text-left absolute  -bottom-[5%] left-[55%] md:left-[75%] lg:left-[90%] md:top-[130%] lg:top-[105%] z-40 w-[80%] sm:w-[90%] break-normal  sm:leading-8'>
          ...
          <img loading='lazy' className='absolute left-[82%] w-[50px] sm:w-[15%] top-[10%] z-20' src="/Assets for Swiftpocket/arrow TopRight.png" alt="" />
          <img loading='lazy' className='absolute top-[67%] left-[80%] md:top-[75%] lg:top-[75%] md:left-[75%] lg:left-[80%] w-[50px] sm:w-[15%] z-20 lg:rotate-0 rotate-[30deg] ' src="/Assets for Swiftpocket/arrowBottomRight.png" alt="" />
