...
const POS = () => {
  ...
  return (
    <div id='POS' className='h-[70vh] md:h-[60vh] lg:h-[70vh] w-screen flex flex-col sm:flex-row '>
        <div className='w-[100vw] sm:w-[50vw] h-[70%] sm:h-[100%] flex gap-10 justify-center items-center sm:pl-[10%] relative'>
          <div className='flex justify-end flex-col absolute w-[100%]  lg:w-[90%] h-[100%]  lg:pl-[5%] pl-[10%] pb-[10%]'>
             <div className='h-[50%]'></div>

              <div className='h-[50%] w-[70%] ml-[10%] lg:ml-[0] lg:w-[90%] -mb-5 lg:-mb-5 z-0'>
        ...
        <div className='sm:w-[50%] sm:h-[100%] h-[20%] pl-10 sm:pl-20 flex justify-start items-center mt-[10%]'>
