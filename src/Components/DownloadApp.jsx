...
const DownloadApp = () => {
  ...
  useEffect(()=>{
    ...
    gsap.fromTo(el1, {rotation:0 , x:0, zIndex:100}, {rotation: -50, x:200, y:-80, zIndex:50, duration:2, delay:2, scrollTrigger:{
      trigger:el1,
      scrub:1
    }})
  ...
  return (
    <div id='download' className='text-white w-screen h-[50vh] flex justify-center items-center'>
        <div id='cardBg' className='bg-[color:var(--secondary-color)] w-[80%] h-[80%] rounded-[30px] flex justify-start items-center pl-[5%]'>
          <div className='' >
            <div className='flex text-[90%] flex-col gap-[15px] justify-start content-center w-[100%]'> 
                ...
                <div className='flex gap-[10px] sm:gap-[20px] w-[80%] sm:w-[100%] pb-1 pr-[50px]'>
                    <button id='playstore' className=' flex justify-center items-center gap-[10px] bg-[color:var(--alternate-primary-color)] p-1 sm:pl-[12px] sm:pr-[12px] sm:pt-[10px] sm:pb-[10px] sm:w-[170px] h-fit sm:h-[65px] w-[170px] rounded-[10px]'>
                          ...
                          <p className='w-[80%] text-[12px] text-left '>Download on <span className='text-[15px]  font-bold sm:text-[18px] font-interHead'>Play Store</span></p>
                      </button>

                      <button id='appstore2' className='flex justify-center items-center gap-[10px] bg-[color:var(--alternate-secondary-color)] p-1 sm:pl-[12px] sm:pr-[12px] sm:pt-[10px] sm:pb-[10px] sm:w-[170px] h-fit sm:h-[65px] w-[170px] rounded-[10px]'>
                          <span className='w-[20px] sm:w-[36px] sm:h-[36px]'>
                              <svg width="" height="" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className='w-[80%] text-[12px]  text-left'>Download on <span className='font-bold text-[15px] sm:text-[18px] font-interHead'>App Store</span></p>
                      </button>

                </div>
                <p className='w-[60%]'>Our mobile app is available for everyone and on all smart phones!</p>
            </div>
          </div>
